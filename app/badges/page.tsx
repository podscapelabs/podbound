...
const badges: PodboundBadgeProps[] = [
  ...
  { title: "Field Pioneer", subtitle: "First expedition", icon: <span>↗</span>, variant: "rare-green", rarity: "Rare", description: "Entered the PodBound Field during the first public playtest." },
...
export default function BadgesPage() {
  return <main id="main" className={`shell ${styles.page}`}>
    <header className={styles.heading}><p className="eyebrow">Field Archive distinctions</p><h1>Badges of the colony.</h1><p>Recognition marks for early testing, Field records, difficult Forecasts, and the colonies that endured them.</p></header>
